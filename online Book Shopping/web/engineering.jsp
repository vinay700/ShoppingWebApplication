...
<div class="super_container">
					...
					<div class="col">
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									<li><a href="#">Engineering<i class="fas fa-chevron-right ml-auto"></i></a></li>
									<li><a href="#">Computer Science<i class="fas fa-chevron-right"></i></a></li>
                                                                        <li><a href="#">Medical<i class="fas fa-chevron-right"></i></a>
									<li><a href="#">Architecture<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="#">Banking<i class="fas fa-chevron-right"></i></a></li>
								</ul>
							</div>
							<!-- Main Nav Menu -->
							<!-- Menu Trigger -->
	...
	<div class="banner">
		<div class="banner_background" style="background-image:url(images/Cpp3.jpg)"></div>
